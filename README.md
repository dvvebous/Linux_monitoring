...
## Результат
- Part 1-6: Реализованные скрипты лежат в директории `src\Script/0x`, где 0x название папки, которое соотвествует скрипту.
- Part 7-9: Отчет о выполнении в `src/REPORT.md`
...
-  Part 7-9: Установка и настройка Grafana и Prometheus, создание дашбордов, уставновка готового дашбоарда и реализация своего node exporter`a.
